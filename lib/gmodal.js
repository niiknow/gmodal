    ...
    if (!that.opts.allowBackgroundFocus && that.el && that.isVisible && (evt.which || evt.keyCode) === 9) {
      if (that.el.contains && !that.el.contains(tg)) {
        ...
        if (that.opts.autoFocusId) {
          var _el = that.doc.getElementById(that.opts.autoFocusId);
...
module.exports = __webpack_require__(/*! /Users/techsupport/Desktop/work/niiknow/gmodal/src/index.js */"./src/index.js");
